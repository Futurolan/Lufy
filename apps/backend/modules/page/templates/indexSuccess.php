...
<?php echo ajax_link('Ajouter une page', 'page/new', array('class' => 'button add'))?>
<?php echo ajax_link('Voir les pages archiv&eacute;es', 'page/archived', array('class' => 'button'))?> 
<?php echo ajax_link('Gerer les cat&eacute;gories', 'pageType/index', array('class' => 'button'))?> 
...
<table class="table">
  ...
  <tbody>
    ...
    <?php if (substr($page->getSlug(), -3, 3) != '-en'): ?>
    <tr>
      <td><?php if ($page->getStatus() == 1): echo image_tag('/css/img/backend/8green.png'); else: echo image_tag('/css/img/backend/8red.png'); endif;?>
      <td>
      ...
      <td style="font-size: 11px;">
        <a class="button small left" href="http://www.gamers-assembly.net/fr/page/<?php echo $page->getSlug()?>" target="_blank">Apercu</a>
