...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td <?php if ($poker_tournament->getIsActive() == 0) echo 'class"inactive"';?>><a href="<?php echo url_for('poker_tournament/edit?id_poker_tournament='.$poker_tournament->getIdPokerTournament()) ?>"><?php echo $poker_tournament->getName() ?></a></td>
      <td>
