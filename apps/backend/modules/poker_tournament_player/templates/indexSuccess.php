<h2>Liste des joueurs poker</h2>
<a class="button" href="<?php echo url_for('poker_tournament_player/new') ?>"><s>Ajouter un joueur</s></a>
<table class="table">
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="<?php echo url_for('poker_tournament_player/edit?id_poker_tournament_player='.$poker_tournament_player->getIdPokerTournamentPlayer()) ?>"><?php echo $poker_tournament_player->getIdPokerTournamentPlayer() ?></a></td>
