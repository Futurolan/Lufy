    ...
    <tfoot>
      <tr>
        <td colspan="2">
          ...
          &nbsp;<a href="<?php echo url_for('mail/index') ?>" class="btn btn-default">Retour &agrave la liste.</a>
          <?php if (!$form->getObject()->isNew()): ?>
            &nbsp;<?php echo link_to('Delete', 'mail/delete?id_mail='.$form->getObject()->getIdMail(), array('method' => 'delete', 'confirm' => 'Are you sure?', 'class' => 'btn btn-default')) ?>
          <?php endif; ?>
