...
<div class="box">
    ...
    <br/>
    <?if ($inviteteam == '1'): ?>
        <?php echo link_to(__('Inviter le joueur &agrave; rejoindre mon equipe'),'invite/addPlayer?username='.$user->getUsername(), array('class' => 'button'))?><br/>
    <?php else: ?>
        <div class="flashbox info">
            <?php echo __('Pour inviter ce joueur a rejoindre votre equipe vous devez etre gerant. Vous ne pouvez pas inviter un joueur si celui ci appartient deja a une autre equipe.')?>
        </div>
    <?endif; ?>
