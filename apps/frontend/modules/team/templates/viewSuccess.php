<div class="box">
    ...
    <?php if (isset($idTeam)): ?>
        ...
        <?php 
        if ($alreadyInTournament == true) {
            foreach($tournaments as $tournament): ?>
                <?php echo __('L equipe est inscrite au tournoi ')?>;
                <?php echo link_to($tournament->getTournament()->getName(), 'tournament/view?slug='.$tournament->getTournament()->getSlug())?>
            <?php endforeach;
        }
        else if ($alreadyInTournament == false) 
        { ?>
            <?php echo __('L equipe n est pas inscrite a un tournoi')?>
		<?
        };
        endif;
                ...
                if (!isset($idTeam)):
?>
<?php echo __('Vous n appartenez a aucune equipe pour le moment.')?><br/>
<?php echo link_to(__('Creer une nouvelle equipe'), 'team/new'); ?>
<?php endif; ?>
</div>
