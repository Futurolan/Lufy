<?php echo link_to('<i class="icon-pencil"></i> '.__('Modifier'), 'team/edit?slug='.$team->getSlug(), array('class' => 'btn btn-primary btn-small')); ?>
<?php echo ' ';?>
<?php echo link_to('<i class="icon-trash"></i> '.__('Supprimer'), 'team/delete?slug='.$team->getSlug(), array('class' => 'btn btn-danger btn-small')); ?>
  ...
  <?php foreach ($team->getTeamPlayer() as $player): ?>
    <tr>
      ...
      <td>
        ...
        <?php echo link_to('<i class="icon-trash" ></i> '.__('Expulser'), 'team/deleteMember?team_id='.$team->getIdTeam().'&user_id='.$player->getSfGuardUser()->getId(), array('class' => 'btn btn-danger btn-mini')); ?> <br/>
      </td>
    </tr>
  <?php endforeach; ?>
</table>

<?php echo link_to('<i class="icon-plus"></i> '.__('Inviter un joueur'), 'team/searchPlayers?slug='.$team->getSlug(), array('class' => 'btn btn-success btn-small')); ?>
