...
<?php if ($team) { ?>
  ...
  <?php if($droits=='1'):?>
    ...
    <?php echo link_to('<i class="icon-trash"></i> '.__('Supprimer'), 'team/deleteTeam', array('class' => 'btn btn-danger', 'method' => 'delete', 'confirm' => __('Etes vous sur de vouloir definitivement supprimer votre team (historique, place dans le tournoi) ?'))) ?>
  <?php endif; ?>
