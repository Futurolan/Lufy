/**
 * This file require jQuery framework
 */
...
function modalPopup(align, top, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, url, loadingImage){
	...
	document.getElementById('outerModalPopupDiv').style.padding = 0 + 'px';
	...
	document.getElementById('innerModalPopupDiv').style.BoxShadow = 0 + 'px 0px 10px red';
	...
	document.getElementById('blockModalPopupDiv').style.background = '#000';
