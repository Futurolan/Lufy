...
class sfGuardRegisterForm extends BaseSfGuardUserForm {
  ...
  {
    unset($this['algorithm'], $this['salt'], $this['group_list'], $this['permissions_list'], $this['groups_list'], $this['is_active'], $this['is_super_admin'], $this['last_login'], $this['created_at'], $this['updated_at']);
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorAnd(array(
        ...
        new sfValidatorReCaptcha(array('private_key' => sfConfig::get('app_recaptcha_private_key'))),
      ))
    );
    ...
    $this->setValidator('first_name', new sfValidatorString(array('required' => true, 'min_length' => 4, 'max_length' => 255)));
    $this->setValidator('last_name', new sfValidatorString(array('required' => true, 'min_length' => 4, 'max_length' => 255)));
    $this->setValidator('email_address', new sfValidatorEmail(array('required' => true),array('required' => 'L\'adresse de courriel est requise','invalid' => 'Ce courriel n\'est pas valide')));
    $this->setValidator('username', new sfValidatorAnd(
                array(
