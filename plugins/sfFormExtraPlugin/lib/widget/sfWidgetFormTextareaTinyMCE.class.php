...
<script type="text/javascript">
  tinyMCE.init({
    ...
    language: "fr",
    theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,sub,sup,|,justifyleft,justifycenter,justifyright,|,link,unlink,anchor,image,preview",
    theme_advanced_buttons2 : "fontselect,formatselect,forecolor,backcolor, table,|,undo,redo,|,bullist,numlist,|,outdent,indent,|,code",
